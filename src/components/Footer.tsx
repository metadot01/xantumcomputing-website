...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-primary overflow-hidden" id="contact">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-secondary/30 to-transparent" />
      <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-secondary/10 rounded-full blur-[150px]" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="space-y-3 mb-8">
                <a href="mailto:contact@xantumcomputing.com" className="group flex items-center gap-3 text-white/70 hover:text-white transition-colors">
                  <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-secondary/20 group-hover:border-secondary/30 transition-all">
                    <Mail className="w-4 h-4" />
                  </div>
                  <span className="text-sm">contact@xantumcomputing.com</span>
                </a>
                <a href="tel:+919741263932" className="group flex items-center gap-3 text-white/70 hover:text-white transition-colors">
                  <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-secondary/20 group-hover:border-secondary/30 transition-all">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/10 border border-white/20 text-white/70 text-xs">
              ...
              <div className="flex gap-2">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:bg-secondary/20 hover:border-secondary/30 transition-all duration-300"
                  >
                    ...
                    <li key={link.name}>
                      {link.isRoute ? (
                        ...
                        <a
                          ...
                          className="group inline-flex items-center gap-1.5 text-sm text-white/60 hover:text-secondary transition-colors"
                        >
                          {link.name}
